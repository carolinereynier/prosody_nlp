...
def main():
    ...
    ta_stats_dir = '/afs/inf.ed.ac.uk/group/msc-projects/s2125019/prosody_nlp/data/ta_features/stats/tree_aligned/'
    alignment_dir = '/afs/inf.ed.ac.uk/group/msc-projects/s2125019/prosody_nlp/data/swbd_word_times/tree_aligned/'


    # First: make or load the big dictionaries that map from sentence to terminal to phonword
    
    print('making term2pw...')
    sentence2_path = os.path.join(data_dir,'sentence2')
    term2pw_path = os.path.join(sentence2_path,'term2pw.pickle')
    term2feats_path = os.path.join(sentence2_path,'term2feats.pickle')
    ...
    sent2pw_path = os.path.join(sentence2_path,'sent2pw.pickle')
    sent2term_path = os.path.join(sentence2_path,'sent2term.pickle')
    ...
    turn2sent_path = os.path.join(sentence2_path,'turn2sent.pickle')
    sent2turn_path = os.path.join(sentence2_path,'sent2turn.pickle')    
    ...
    avg_dur_dir = '/afs/inf.ed.ac.uk/group/msc-projects/s2125019/prosody_nlp/data'
    wordstats_json = 'avg_word_stats.json'
    orth2meandur,orth2freq = load_orth2meandur_json(avg_dur_dir,wordstats_json)

    phone2meandur_path = os.path.join(sentence2_path,'phone2meandur.pickle')
    ...
    pw2pause_path = os.path.join(sentence2_path,pw2pause_file)
    ...
    kaldi_feat_dir_mfcc = '/afs/inf.ed.ac.uk/group/msc-projects/s2125019/prosody_nlp/data/new_output/'
    kaldi_feat_dir = '/afs/inf.ed.ac.uk/group/project/prosody/prosody_nlp/data/kaldi_feats/'
    mfcc_dir = os.path.join(kaldi_feat_dir_mfcc,'swbd_mfcc')
